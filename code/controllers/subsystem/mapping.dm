...
/datum/controller/subsystem/mapping/proc/loadWorld()
	...
	else if(current_map.minetype == "lavaland_empty")
		LoadGroup(FailedZs, "Lavaland", "map_files/Mining", "Lavaland_Empty.dmm", default_traits = ZTRAITS_LAVALAND)
...
/datum/controller/subsystem/mapping/proc/preloadRuinTemplates()
	...
	if(current_map.minetype == "lavaland" || current_map.minetype == "lavaland_empty")
